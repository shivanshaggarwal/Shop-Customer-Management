                                ...
                                <div className="col-md-4 my-3">
                                    <div className={`${style.card} card`}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-title">Item Price: {item.item_price}</h5>
                                            <h5 className="card-title">Down Payment: {item.down_payment}</h5>
                                            <h5 className="card-title">Emi_Amount: {item.emi_amount}</h5>
                                            <p className="card-title"><span className='fw-bold fs-4'>Address:</span> {item.address}</p>
                                                <h5 className="card-title">Expiry Date: {item.due_1}</h5>
                                                <h5 className="card-title">Expiry Date: {item.amount_1}</h5>
                                                <h5 className="card-title">Expiry Date: {item.due_2}</h5>
                                                <h5 className="card-title">Expiry Date: {item.amount_2}</h5>
                                                <h5 className="card-title">Expiry Date: {item.due_3}</h5>
                                                <h5 className="card-title">Expiry Date: {item.amount_3}</h5>
                                                <h5 className="card-title">Expiry Date: {item.due_4}</h5>
                                                <h5 className="card-title">Expiry Date: {item.amount_4}</h5>
                                                <h5 className="card-title">Expiry Date: {item.due_5}</h5>
                                                <h5 className="card-title">Expiry Date: {item.amount_5}</h5>
                                        </div>
                                        <ul className="list-group list-group-flush">
                                            <li className={`${style.line} list-group-item`}>
                                                ...
                                                <p className="card-title"><span className='fw-bold fs-4'>Address:</span> {item.address_1}</p>
                                            </li>
                                            <li className={`${style.line} list-group-item`}>
                                                <h5 className="card-title">Associate_Name: {item.associate_2}</h5>
                                                <h5 className="card-title">Phone Number: {item.phone_number_2}</h5>
                                                <p className="card-title"><span className='fw-bold fs-4'>Address:</span> {item.address_2}</p>
                                            </li>
                                            <li className={`${style.line} list-group-item`}>
                                                <h5 className="card-title">Associate_Name: {item.associate_3}</h5>
                                                <h5 className="card-title">Phone Number: {item.phone_number_3}</h5>
                                                <p className="card-title"><span className='fw-bold fs-4'>Address:</span> {item.address_3}</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
